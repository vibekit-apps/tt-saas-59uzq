...
App: **tt-saas-59uzq** at https://tt-saas-59uzq.vibekit.bot
Repo: template/saas | Port: 4043 | Container: vk-tt-saas-59uzq
...
- Never mention localhost. App URL: **https://tt-saas-59uzq.vibekit.bot**.
- Verify before claiming success: `curl -s -o /dev/null -w "%{http_code}" https://tt-saas-59uzq.vibekit.bot/`.
